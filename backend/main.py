...
from utils.nsedata import get_ohlc_data, get_nse_index_data, nse_get_index_quote
from utils.scanner import get_ltp
import json
...
@app.get("/nseindices")
async def nse_index_data():
    return nse_get_index_quote("nifty bank")

@app.get("/nsescanner")
async def nse_index_data():
    return get_ltp("BANKBEES")